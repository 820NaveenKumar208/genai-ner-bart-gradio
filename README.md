...
demo = gr.Interface(
    ...
    examples=[
        "My name is Naveen Kumar T , works at HuggingFace in Chennai."
    ]
)
...
### OUTPUT:
<img width="1866" height="885" alt="image" src="https://github.com/user-attachments/assets/f77852a2-15c5-4cf3-8d09-56fa1a1a7633" />
